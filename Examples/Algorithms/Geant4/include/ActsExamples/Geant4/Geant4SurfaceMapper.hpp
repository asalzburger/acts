...
class Geant4SurfaceMapper {
 public:
  ...
  struct Config {
    ...
    std::string mappingPrefix = "ActsGeoID#";
  };
  ...
  Geant4SurfaceMapper(const Config& cfg,
                      std::unique_ptr<const Acts::Logger> logger =
                          Acts::getDefaultLogger("Geant4SurfaceMapper",
                                                 Acts::Logging::INFO));
  ~Geant4SurfaceMapper() = default;
  ...
  /// @param trackingGeometry the ACTS geometry for the association
