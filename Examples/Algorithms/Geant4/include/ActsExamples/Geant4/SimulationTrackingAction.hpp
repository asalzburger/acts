...
class SimulationTrackingAction : public G4UserTrackingAction {
 public:
  struct Config {
  ...
  SimulationTrackingAction(
      const Config& cfg,
      std::unique_ptr<const Acts::Logger> logger = Acts::getDefaultLogger(
          "SimulationTrackingAction", Acts::Logging::INFO));
  ~SimulationTrackingAction() override = default;
