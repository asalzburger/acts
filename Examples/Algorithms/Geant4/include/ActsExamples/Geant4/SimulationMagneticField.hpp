...
class SimulationMagneticField : public G4MagneticField {
 public:
  ...
  SimulationMagneticField(const Config& cfg,
                          std::unique_ptr<const Acts::Logger> logger =
                              Acts::getDefaultLogger("SimulationMagneticField",
                                                     Acts::Logging::INFO));
  ~SimulationMagneticField() override = default;
