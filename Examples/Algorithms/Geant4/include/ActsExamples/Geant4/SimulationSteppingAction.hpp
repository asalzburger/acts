...
class SimulationSteppingAction : public G4UserSteppingAction {
 public:
  /// Configuration of the Stepping action
  struct Config {
    /// Matching string for the sensitive part
  ...
  SimulationSteppingAction(
      const Config& cfg,
      std::unique_ptr<const Acts::Logger> logger = Acts::getDefaultLogger(
          "SimulationSteppingAction", Acts::Logging::INFO));
  ~SimulationSteppingAction() override = default;
