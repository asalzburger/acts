...
ActsExamples::Geant4::SimulationMagneticField::SimulationMagneticField(
    const Config& cfg, std::unique_ptr<const Acts::Logger> logger)
    : G4MagneticField(), m_cfg(cfg), m_logger(std::move(logger)) {}

void ActsExamples::Geant4::SimulationMagneticField::GetFieldValue(
    const G4double Point[4], G4double* Bfield) const {
  constexpr double convertLength = Acts::UnitConstants::mm / CLHEP::mm;
  constexpr double convertField = Acts::UnitConstants::T / CLHEP::tesla;
