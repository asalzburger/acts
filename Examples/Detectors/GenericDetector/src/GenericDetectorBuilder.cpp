...
GenericDetectorBuilder::GenericDetectorBuilder(
  ...
  std::vector<Acts::DirectedProtoAxis> pCylinderAxes = {
      Acts::DirectedProtoAxis(Acts::AxisDirection::AxisPhi,
                              Acts::AxisBoundaryType::Closed, -1., 1., 10u),
      Acts::DirectedProtoAxis(Acts::AxisDirection::AxisZ,
                              Acts::AxisBoundaryType::Open, -1., 1., 10u)};
  ...
  std::vector<Acts::DirectedProtoAxis> pDiscAxes = {
      Acts::DirectedProtoAxis(Acts::AxisDirection::AxisR,
                              Acts::AxisBoundaryType::Open, 0., 1., 10u),
      Acts::DirectedProtoAxis(Acts::AxisDirection::AxisPhi,
                              Acts::AxisBoundaryType::Closed, -1., 1., 10u)};
  auto pDiscMaterial =
      std::make_shared<const Acts::ProtoSurfaceMaterial>(pDiscAxes);
  // - plane
  std::vector<Acts::DirectedProtoAxis> pPlaneAxes = {Acts::DirectedProtoAxis(
